...
#define RX_PIN                  HW_GPIO_PIN_1
#define TX_PORT                 HW_GPIO_PORT_3
#define TX_PIN                  HW_GPIO_PIN_2
...
void ble_multi_link_task(void *params)
{
        ...
        //hw_gpio_configure_pin(HW_GPIO_PORT_3, HW_GPIO_PIN_3, HW_GPIO_MODE_INPUT,HW_GPIO_FUNC_GPIO,true);
        //OS_DELAY(1);
