...
extern void send_network(uint8_t *pbuf,uint8_t len);
extern void broadcast_data(uint8_t *buf, uint16_t len);//广播数据的处理
extern void broadcast_net_message(uint8_t *pbuf,uint16_t len);
