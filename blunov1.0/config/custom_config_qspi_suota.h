...
#define dg_configIMAGE_FLASH_OFFSET             (0x25000)
...
#define dg_configBATTERY_CHARGE_CURRENT         0xD       // 400mA
...
#if (dg_configUSE_SOC)
        #if defined(DEBUG_SOC)
                #define configTOTAL_HEAP_SIZE                    (18000)//(13500 + SUOTA_HEAP_OVERHEAD)   /* This is the FreeRTOS Total Heap Size */
        #else
                #define configTOTAL_HEAP_SIZE                    (18000)   /* This is the FreeRTOS Total Heap Size */
        #endif
#else
